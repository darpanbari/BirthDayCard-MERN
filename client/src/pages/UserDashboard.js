...
const UserDashboard = () => {
  ...
  return (
    <>
      <div>
        <div className="d-flex" style={{ background: "#60B99D", height: "100vh", width:"92.2vw" }}>
            ...
            >
                    ...
                    <Col key={i}>
                      ...
                      >
                        ...
                        <Card.Body className="p-0">
                          ...
                          <Card.Text className="text-center fst-italic text-white mb-0">
              ...
              >
                <Col className="d-flex flex-row" style={{ margin: "92px 0px" }}>
                  <Card
                    style={{
                  ...
                  >
                    ...
                    <Card.Body>
                      ...
                      <Card.Text className="text-center text-warning fs-4 fst-italic px-5">
                        ...
                        <span className="text-danger">Happy birthday!</span>
                      </Card.Text>
...
<Col className="d-flex flex-row" style={{ margin: "92px 0px" }}>
  ...
  >
    ...
    <Card.Body>
      ...
      <Card.Text className="text-center text-warning fs-4 fst-italic px-5">
        “Count not the candles…see the lights they give. Count not
        the years, but the life you live. Wishing you a wonderful
        time ahead.”<br></br>
        <span className="text-danger">Happy birthday!</span>
      </Card.Text>
      <Card.Text className="text-center fw-bold text-success">
